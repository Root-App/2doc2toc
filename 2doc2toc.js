...
function printUsageAndExit(isErr) {
  ...
  outputFunc('Usage: 2doc2toc [mode] [--entryprefix prefix] [--notitle | --title title] [--maxlevel level] [--all] [--update-only] [--build-parent-tocs=rootDir] <path> (where path is some path to a directory (e.g., .) or a file (e.g., README.md))');
  outputFunc('\nAvailable modes are:');
